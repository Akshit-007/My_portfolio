...
function Contact() {
    ...
    return (
        <div className="w-9/10 min-h-9/10 bg-gray-800 mx-auto mt-10 rounded-lg shadow-2xl p-8">
            ...
            <div className="flex flex-col">
                <div className="mx-auto">
                    <form className="bg-gray-200 p-4 w-56 md:w-64 lg:w-80 rounded-xl" onSubmit={sendEmail} >
                        <div className="text-purple-600 text-xs md:text-sm lg:text-lg"><i class="fa fa-envelope-o"></i> - akshittrivedi1002@gmail.com <br /><br /></div>
                ...
                <div className="mx-auto">
                    <div className="bg-gray-200 h-10 w-56 md:w-64 lg:w-80 rounded-xl flex flex-row justify-around">
                        ...
                        <div className="text-white pt-1"><a href="https://twitter.com/akshit_1005" target="_blank"><i className=" transition duration-500 ease-in-out fa fa-twitter rounded-full text-2xl pl-2 bg-white text-purple-600 shadow-lg w-9 h-8 hover:bg-purple-600 hover:text-white"></i></a></div>
                    </div>
                </div>
            </div>
